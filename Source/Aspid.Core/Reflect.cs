...
namespace Aspid.Core
{
    ...
    public static class Reflect<TTarget>
    {
        ...
        /// <returns></returns>
        public static string PropertyName(Expression<Func<TTarget, object>> property)
        {
            return Property(property).Name;
        }

        public static string PropertyPath(Expression<Func<TTarget, object>> property)
        {
            return GeneratePropertyPath((Expression)property);
        }

        static string GeneratePropertyPath(Expression pathExpression)
        {
            ...
            else if (pathExpression.NodeType == ExpressionType.MemberAccess)
            {
                ...
                return path + (path.IsNullOrEmpty() ? "" : ".") + memberExpression.Member.Name;
            }
        ...
        public static PropertyInfo Property(Expression<Func<TTarget, object>> property)
        {
        ...
        public static FieldInfo Field(Expression<Func<TTarget, object>> field)
        {
